...
export default function PanelInterviewPage() {
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      // Filter for interview campaigns (including those without campaign_type for backward compatibility)
      const interviewCampaigns = (data.campaigns || []).filter((campaign: Campaign) => 
        !campaign.campaign_type || campaign.campaign_type === 'interview'
      )
      setCampaigns(interviewCampaigns)
    } catch (error) {
      toast({
        title: "Error",
      ...
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Here are all the panel interview campaigns you have created.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mt-1">Get started by creating a new interview campaign.</p>
              </div>
            )}
          </CardContent>
        </Card>
